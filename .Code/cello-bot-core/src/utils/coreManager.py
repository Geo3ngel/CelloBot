...
class CoreManager(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        logger.info("CoreManager application layer initialized!")
    ...
    async def setup(self):
        ...
        logger.info("CoreManager application layer setup!")

    def cleanup(self):
        logger.debug("CoreManager application layer cleaning up")
        if self.comp_manager:
            self.comp_manager.cleanup()
        logger.info("CoreManager application layer cleaned up")
    ...
    and new conversation history will be used to prompt CoreManager.
